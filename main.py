...
logger = logging.getLogger("intellectai")
console = Console()

def main():
    parser = argparse.ArgumentParser(description="IntellectAI - Advanced Research Assistant")
    args = parser.parse_args()

    console.print(Panel("[bold cyan]Welcome to IntellectAI - Advanced Research Assistant[/bold cyan]", expand=False))
    ...
    console.print("\n")
    console.print(Panel("Research Report Completed", style="bold green"))
    ...
    filename = f"output/intellectai_{topic.lower().replace(' ', '_')}.md"
